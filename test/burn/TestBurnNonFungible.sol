...
contract TestBurnNonFungible {
    ...
    function testWhenSuccess() external {
      ...
      Assert.equal(credit.totalSupply(contractType), 0, "the total supply of this credit id/type after being burned should be 0");
      Assert.equal(credit.totalSupply(contractType + 1), 0, "the total supply of this credit id/type after being burned should be 0");
    }
}
