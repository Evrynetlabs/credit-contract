...
contract TestValidParameters {
    ...
    function fillUpMintNonFungible() internal {
        ...
        credit.mintNonFungible(credit.getNonFungibleBaseType(ids[ids.length - 1]), _senders);
    }
    ...
    function testFullBatchTransfer() external {
         ...
         */
        Assert.equal(credit.balanceOf(address(sender), ids[0]), 0, "balance of non fungible credit id[0] of the sender should be 0");
        ...
        */
        Assert.equal(credit.balanceOf(address(receiverAccountAddr), ids[0]), defaultValue, "balance of the receiver of id[0] should be 1");
        Assert.equal(credit.balanceOf(address(receiverContract), ids[1]), defaultValue, "balance of the receiver of id[1] should be 1");
        Assert.equal(credit.balanceOf(address(receiverAccountAddr), ids[2]), defaultValue, "balance of the receiver of id[2] should be 1");
        Assert.equal(credit.balanceOf(address(receiverContract), ids[3]), defaultValue, "balance of the receiver of id[3] should be 1");
        Assert.equal(credit.balanceOf(address(receiverAccountAddr), ids[4]), defaultValue, "balance of the receiver of id[4] should be 1");
        Assert.equal(credit.balanceOf(address(receiverContract), ids[5]), defaultValue, "balance of the receiver of id[5] should be 1");
        Assert.equal(credit.balanceOf(address(receiverAccountAddr), ids[6]), defaultValue, "balance of the receiver of id[6] should be 1");
        Assert.equal(credit.balanceOf(address(receiverContract), ids[7]), defaultValue, "balance of the receiver of id[7] should be 1");
    }
}